  ...
  return (
    <div className='about'>
      ...
      <div className="about-right">
        ...
        <p>GH Academy is a premier technology training institute based in Nandyal, Andhra Pradesh, dedicated to empowering students and professionals with in-demand skills in the fields of software development, data science, AI/ML, cloud computing, and more.</p>
